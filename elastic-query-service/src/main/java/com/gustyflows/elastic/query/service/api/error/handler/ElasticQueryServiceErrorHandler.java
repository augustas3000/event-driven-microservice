package com.gustyflows.elastic.query.service.api.error.handler;
...
public class ElasticQueryServiceErrorHandler {
    ...
    public ResponseEntity<String> handle(Exception e) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("A server errror occurred!");
    }
